...
#Notion export PATH=$HOME/bin:/usr/local/bin:$PATH
...
alias create-project="/usr/local/bin/tmux-create-project"

alias gs='git switch $(git branch | sed "s/[\*|^\ ]//" | fzf)'
alias gd='git branch -d $(git branch | sed "s/[\*|^\ ]//" | fzf)'
alias gD='git branch -D $(git branch | sed "s/[\*|^\ ]//" | fzf)'
alias :q='exit'
